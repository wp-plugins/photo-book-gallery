	...
	function render_menu_page(){
		...
		?>
			<div class="wrap" id="photo-book">
				<h2><?php _e( 'Photo Book Gallery Settings', 'photo-book-gallery' ); ?> <a title="Need Help?" target="_blank" href="http://webcodingplace.com/photo-book-gallery/"><span class="dashicons dashicons-editor-help"></span></a></h2>
