	...
	function render_menu_page(){
		...
		?>
			<div class="wrap" id="photo-book">
				<h2><?php _e( 'Photo Book Gallery Settings', 'photo-book-gallery' ); ?> <a class="add-new-h2" target="_blank" href="https://wordpress.org/support/view/plugin-reviews/photo-book-gallery"><?php _e( 'Please Rate this plugin', 'photo-book-gallery' ); ?></a></h2>
