	...
	function render_menu_page(){
		...
		?>
			<div class="wrap" id="photo-book">
				<h2><?php _e( 'Photo Book Gallery Settings', 'photo-book-gallery' ); ?> <a class="add-new-h2" target="_blank" href="http://webcodingplace.com/photo-book-gallery-pro-wordpress-plugin/"><?php _e( 'Get Pro', 'photo-book-gallery' ); ?></a></h2>
